...
<style>
    ...
    .product-card:hover {
        ...
        box-shadow: 0 10px 20px rgba(62, 124, 177, 0.2); /* Bayangan menggunakan Steel Blue */
...
<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
    ...
    <div class="col">
        <div class="product-card h-100 d-flex flex-column">
            <a href="{{ route('katalog.show', $karya->id) }}" class="text-decoration-none text-dark flex-grow-1 d-flex flex-column">
                ...
                <div class="p-3 d-flex flex-column flex-grow-1">
                    ...
                    <small class="text-muted mb-3"><i class="bi bi-person-fill me-1" style="color: var(--steel-blue);"></i> {{ $karya->pembuat->name ?? 'Siswa' }}</small>
